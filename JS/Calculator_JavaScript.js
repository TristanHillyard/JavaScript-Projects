...
const Calculator = {
    ...
    First_Operand: null, //hold the first operand for any expressions, we seti it to null for now
    Wait_Second_Operand: false, //second operand has been input
    operator: null,//will hold operand, is null for now.
};
...
function Handle_Operator(Next_Operator) {
    ...
    //checks if an operator already exists and if Wait_operand is true,
